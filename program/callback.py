...
💭 [❰ 亗『𝐊𝐀𝐓𝐈𝐋』亗 MUSIC ❱](https://t.me/katil_vc_player_bot) **ALLOWS YOU TO PLAY MUSIC AND VIDEO ON GROUPS THROUGH THE NEW TELEGRAM's VIDEO CHATS!**
...
3.) Invite @KATIL_ASSISTANT to your group or type /userbotjoin to invite her, unfortunately the userbot will joined by itself when you type `/play (song name)` or `/vplay (song name)`.
...
💡 If you have a follow-up questions about this bot, you can tell it on my support chat here: @FULL_MASTI_CLUBS""",
        reply_markup=InlineKeyboardMarkup(
...
⚡️ __Powered by @FULL_MASTI_CLUBS AI__""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🔙 Go Back", callback_data="command_list")]]
        ),
    )
...
⚡ __Powered by @FULL_MASTI_CLUBS AI__""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🔙 Go Back", callback_data="command_list")]]
        ),
    )
